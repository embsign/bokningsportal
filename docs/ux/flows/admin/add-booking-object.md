# Flow: Lägg till bokningsobjekt

Syfte: Skapa ett nytt bokningsobjekt i admin‑dashboard.

1. **Admin Dashboard**
   - Dashboard visar befintliga bokningsobjekt i en tabellöversikt.
   - Två vägar att skapa nytt:
     - **Lägg till** (nytt från scratch)
